...
# Get the absolute path of the upper folder
...
<svg width="400" height="110" viewBox="50 50 400 120" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(50,50)">
    ...
    <!-- Line connecting nodes (Now light gray) -->
    <line x1="45" y1="30" x2="95" y2="45" stroke="#BDC3C7" stroke-width="3"/>

    <!-- NLP Nodes -->
    <circle cx="95" cy="45" r="6" fill="#1ABC9C"/>
    <circle cx="45" cy="30" r="6" fill="#d55e00"/>  <!-- Orange point moved to the front -->
  </g>
  ...
  <!-- Slogan "LANGUAGE AUTOMATION" now correctly placed below -->
...
# Display the same SVG in the sidebar (with a reduced width)
...
# Initialize SpellChecker (pyspellchecker)
spell = SpellChecker()
...
if choice == "🚀 Introduction":
    # Display SVG in Streamlit using st.image()
    st.image("logo.svg")

    st.title("Learning NLP - Quick Overview")
    # Merged welcome and introduction text
    st.markdown(
        """
    ...
    annotated_text(
        ("Natural Language Processing (NLP)", "Love this! ❤"), " is a field of ", ("Artificial Intelligence", "Too! ❤"), " focused on enabling ", ("computers", "noun"), " to understand and process ", ("human language", "Really??"),".",  
                    
        "\nI'm sharing examples of how, using Python and various libraries, we can unveil the secrets of language. This app is built using **Streamlit**, designed specifically for ", ("Machine Learning", "term")," and ", ("Data Science", "term")," projects.")
    ...
    #df_nlp_tasks = pd.DataFrame(nlp_tasks, columns=["NLP Tasks"])

    # Mostrar el DataFrame y el texto en dos columnas
    ...
    # Expandable section about the author
...
# Sample documents (each line represents a document)
docs = [
    "Document one text goes here.",
    "Document two text goes here."
]
...
This example uses a **Hugging Face Transformers** pipeline to translate text from one language to another.
    ...
    # Define a dictionary of languages and their codes
    languages = {
        "English": "en",
        "French": "fr",
        "German": "de",
    ...
    if st.button("Translate"):
        ...
        # Initialize the translation pipeline with the chosen languages
        translator = pipeline(
...
# Define language codes for source and target languages
source_lang = "en"  # e.g. English
target_lang = "fr"  # e.g. French

translator = pipeline("translation_{}_to_{}".format(source_lang, target_lang), model=f"Helsinki-NLP/opus-mt-{source_lang}-{target_lang}")
...
This example uses the **pyspellchecker** library.
    ...
    if st.button("Correct Spelling"):
        ...
        # Identify only the unknown (misspelled) words
...
🔗 **Continue Learning:**  
For a deeper dive into NLP, check out the full article:  
[**Learning NLP – Quick Overview with Sample Codes**](https://www.veriloquium.com/learning-nlp-quick-overview-with-sample-codes/)
    """)
    st.markdown("---")
...
#####################
    ...
    # Title and Header
    st.header("☕ Welcome to My Coffee Corner!")
    st.write("Hi! I'm **Sergio Calvo Páez**, a computational linguist, localization expert, and NLP specialist passionate about bridging AI and language.")

    # About Section
    st.write(
        "Over the years, I’ve worked with major companies like **Spotify, Google, Apple, and Amazon**, helping refine translation quality, terminology management, and automation in localization."
    )

    st.subheader("🚀 What I Do")
    st.write("Here, I share my knowledge, build AI-powered tools for translators and linguists, and develop innovative solutions like:")

    st.markdown("""
    - 🚀 **An advanced Localization QA tool** that enhances translation quality.  
    - 🔍 **A job search tracker** for localization professionals.  
    - 🧠 **A personality analysis AI tool** blending psychology and machine learning.  
    - 📖 **Articles & educational content** about NLP, localization, and AI.  
    """)

    st.subheader("☕ Why Your Support Matters")
    st.write("If you find my work valuable, you can **support me with a coffee** to keep these projects going. Every cup fuels my mission to make language tech smarter and more accessible.")

    # Call to Action
    st.write("Thanks for being here! 🚀☕")
    button(username="sergiocalvc", floating=False, width=221) 
...
###############################################################################
    ...
    Every coffee fuels **more research, coding, and open-source contributions!** 🚀🔥  
        """)
    # Coffee button with hyperlink
    coffee_button = """
    <div style="display: flex; justify-content: center;">
        <a href="https://www.buymeacoffee.com/sergiocalvc" target="_blank">
            <img src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=☕&slug=veriloquium&button_colour=FFDD00&font_colour=000000&font_family=Arial&outline_colour=000000&coffee_colour=ffffff" alt="Buy Me a Coffee">
        </a>
    </div>
    """
...
# Footer
###############
st.markdown("""<p style='text-align: center;'> Brought to you with <span style='color:red'>❤</span> by <a href='https://www.veriloquium.com/'>Sergio Calvo</a> | Veriloquium © LocNLP Lab23 </p>""", unsafe_allow_html=True)
